...
if(isset($_POST["btn_web"]))
{
  ...
  if($_FILES["back_login_image"]["tmp_name"]!=''){
   ...
   $q1="UPDATE `manage_website` SET `title`='$title',`short_title`='$short_title',`logo`='$website_logo',`footer`='$footer' ,`currency_code`= '$currency_code',`currency_symbol`= '$currency_symbol', `background_login_image` = '$background_login_image'";
                                       ...
                                       <!--   <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="uploadImage/Logo/<?=$website_logo?>" style="height:35%;width:25%;"></image>
                          ...
                          <input type="file" class="form-control" name="invoice_image">
                                          ...
                                          <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="uploadImage/Logo/<?=$background_login_image?>" style="height:35%;width:35%;"></image>
