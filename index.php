                            ...
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <?php  if($_SESSION["id"]=='1') {
                                     $sql="SELECT SUM(amount) FROM `products`";
                                  }else
                                  {
                                    $sql="SELECT SUM(amount) FROM `products` WHERE user_id = '".$_SESSION['id']."'";
                                  }
                                $res = $conn->query($sql);
                        ...
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <?php 
                                     if($_SESSION["id"]=='1') {
                                     $sql="SELECT SUM(levy) FROM `products`";
                                  }else
                                  {
                                    $sql="SELECT SUM(levy) FROM `products` WHERE user_id = '".$_SESSION['id']."'";
                                  }
                                  
                                $res = $conn->query($sql);
                                $row=mysqli_fetch_array($res);?> 
                                    <h2 class="color-black"><?php echo $row[0];?></h2>
                                    <p class="m-b-0">total Levy</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                  ...
                                  {
                                    $sql="SELECT COUNT(*) FROM `tbl_booking` WHERE user_id = '".$_SESSION['id']."'";
                                  }
  ...
  $(function () {
    ...
    include 'connect.php';
     ...
     $sql = "SELECT * FROM `tbl_booking`";
      ...
      {
         $sql = "SELECT * FROM `tbl_booking` WHERE user_id = '".$_SESSION['id']."'";
